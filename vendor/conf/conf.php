...
class Conf
{
    ...
    {
        return (\Mezon\getConfigValue($Route, $DefaultValue));
    }
    ...
    {
        \Mezon\setConfigValue($Route, $Value);
    }
    ...
    {
        \Mezon\addConfigValue($Route, $Value);
    }
    ...
    {
        return (\Mezon\configKeyExists($Route));
    }
    ...
    {
        return (\Mezon\deleteConfigValue($Route));
    }
    ...
    {
        \Mezon\addConnectionToConfig($Name, $DSN, $User, $Password);
    }
    ...
    {
        return (\Mezon\expandString($Value));
    }
}
